import { DeckType, DeckToCreateType } from "../../entities/Deck.entity";
 ...
 */
export class CreateDeckRepository extends CreateRepository<DeckToCreateType, DeckType> {
    /**
     * Creates a new Deck entity.
     * @param entity - The Deck data to create.
     * @returns The created Deck entity.
     */
    async run(entity: DeckToCreateType): Promise<DeckType> {
